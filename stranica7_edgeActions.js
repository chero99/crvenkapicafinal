...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_button_next}", "touchstart", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("stranica8.html", "_self");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena7_button_all}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_str8}", "touchstart", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("stranica8.html", "_self");
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena7_lovac_sprite_1}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_button_mute}", "touchstart", function(sym, e) {
         sym.getComposition().getStage().stranica7.stop();
