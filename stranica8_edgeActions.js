...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_button_back}", "touchstart", function(sym, e) {
         ...
         window.open("stranica7.html", "_self");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena8_all}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_str4}", "touchstart", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("stranica4.html", "_self");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_str7}", "touchstart", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("stranica7.html", "_self");
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena5_vuk_sprite}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena5_vuk'

   //=========================================================
   
   //Edge symbol: 'scena5_drvo_ptice'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena5_drvo1}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena5_drvo_ptice'

   //=========================================================
   
   //Edge symbol: 'scena5_ptica_plava'
   (function(symbolName) {   
   ...
   //Edge symbol end:'scena5_ptica_plava'

   //=========================================================
   
   //Edge symbol: 'scena5_ptica_crvena'
   (function(symbolName) {   
   ...
   //Edge symbol end:'scena5_ptica_crvena'

   //=========================================================
   
   //Edge symbol: 'scena5_ptica_zuta'
   (function(symbolName) {   
   ...
   //Edge symbol end:'scena5_ptica_zuta'

   //=========================================================
   
   //Edge symbol: 'scena5_grmlje_jez'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena5_grmlje}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena5_grmlje_jez'

   //=========================================================
   
   //Edge symbol: 'scena6_vuk'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena6_vuk_sprite}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena6_vuk'

   //=========================================================
   
   //Edge symbol: 'scena6_crvenkapica'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena6_crvenkapica_sprite}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena6_crvenkapica'

   //=========================================================
   
   //Edge symbol: 'scena6_misja_rupa_mis'
   (function(symbolName) {   
   
      Symbol.bindElementAction(compId, symbolName, "${_scena5_misjarupa}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena6_misja_rupa_mis'

   //=========================================================
   
   //Edge symbol: 'scena6_prozor1'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena5_prozor1_open}", "touchstart", function(sym, e) {
         sym.play("position");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena5_prozor1_closed}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena6_prozor1'

   //=========================================================
   
   //Edge symbol: 'scena6_prozor2'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena5_prozor2_open}", "touchstart", function(sym, e) {
         sym.play("position");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena5_prozor2_closed}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena6_prozor2'

   //=========================================================
   
   //Edge symbol: 'scena6_nocni_ormaric'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena5_nocni_ormaric_on}", "touchstart", function(sym, e) {
         sym.play("position");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena5_nocni_ormaric_off}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena6_nocni_ormaric'

   //=========================================================
   
   //Edge symbol: 'scena7_lovac_vrata'
   (function(symbolName) {   
   
   })("scena7_lovac_vrata");
   //Edge symbol end:'scena7_lovac_vrata'

   //=========================================================
   
   //Edge symbol: 'scena7_1_lovac_vuk_baka_crvenkapica'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena7_1_lovac_sprite}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena7_1_lovac_vuk_baka_crvenkapica'

   //=========================================================
   
   //Edge symbol: 'scena7_all'
   (function(symbolName) {   
   
   })("scena7_all");
   //Edge symbol end:'scena7_all'

   //=========================================================
   
   //Edge symbol: 'scena7_button_all'
   (function(symbolName) {   
   
   })("scena7_button_all");
   //Edge symbol end:'scena7_button_all'

   //=========================================================
   
   //Edge symbol: 'scena7_all1'
   (function(symbolName) {   
   
   })("scena7_all1");
   //Edge symbol end:'scena7_all1'

   //=========================================================
   
   //Edge symbol: 'scena7_1_nocni_ormaric'
   (function(symbolName) {   
   
   })("scena7_1_nocni_ormaric");
   //Edge symbol end:'scena7_1_nocni_ormaric'

   //=========================================================
   
   //Edge symbol: 'scena8_vuk_vrata'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena8_kuca_vrata}", "touchstart", function(sym, e) {
         sym.play("position");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena8_vuk_sprite}", "touchstart", function(sym, e) {
         // insert code to be run when a user touches the object (for touch devices only)
         sym.play("position");
   ...
   //Edge symbol end:'scena8_vuk_vrata'

   //=========================================================
   
   //Edge symbol: 'scena8_all'
   (function(symbolName) {   
   
   })("scena8_all");
   //Edge symbol end:'scena8_all'

   //=========================================================
   
   //Edge symbol: 'scena8_1_lovac'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena8_1_lovac_sprite}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena8_1_lovac'

   //=========================================================
   
   //Edge symbol: 'scena8_1_crvenkapica'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena8_1_crvenkapica_sprite}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena8_1_crvenkapica'

   //=========================================================
   
   //Edge symbol: 'scena8_1_baka'
   (function(symbolName) {   
   
      Symbol.bindElementAction(compId, symbolName, "${_scena8_1_baka_sprite}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena8_1_baka'

   //=========================================================
   
   //Edge symbol: 'scena8_1_ormar5'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena8_1_ormar5_open}", "touchstart", function(sym, e) {
         sym.play("position");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena8_1_ormar5_closed}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena8_1_ormar5'

   //=========================================================
   
   //Edge symbol: 'scena8_1_prozor1'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena8_1_prozor1_open}", "touchstart", function(sym, e) {
         sym.play("position");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena8_1_prozor1_closed}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena8_1_prozor1'

   //=========================================================
   
   //Edge symbol: 'scena8_1_prozor2'
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena8_1_prozor2_open}", "touchstart", function(sym, e) {
         sym.play("position");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_scena8_1_prozor2_closed}", "touchstart", function(sym, e) {
         sym.play("position");
   ...
   //Edge symbol end:'scena8_1_prozor2'
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_button_mute}", "touchstart", function(sym, e) {
         sym.getComposition().getStage().stranica8.stop();
