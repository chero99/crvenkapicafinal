...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_str1}", "touchstart", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("stranica1.html", "_self");
   ...
   //Edge symbol: 'scena3_crvenkapica_vuk_kamenje'
   (function(symbolName) {   
   ...
   //Edge symbol end:'scena3_crvenkapica_vuk_kamenje'

   //=========================================================
   
   //Edge symbol: 'scena3_kamenje1'
   (function(symbolName) {   
   ...
   //Edge symbol end:'scena3_kamenje1'
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_button_mute}", "touchstart", function(sym, e) {
         sym.getComposition().getStage().stranica3.stop();
