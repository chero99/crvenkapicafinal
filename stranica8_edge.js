...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'scena8_1_soba',
            type:'image',
            rect:['0px','-55px','1280px','853px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"scena8_1_soba.png",'0px','0px']
         },
         {
            id:'scena8_1_ormari_back',
            type:'image',
            rect:['80px','-55px','1200px','650px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"scena8_1_ormari_back.png",'0px','0px']
         },
         {
            id:'scena8_1_ormar1_closed',
            type:'image',
            rect:['85px','-51px','196px','641px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"scena8_1_ormar1_closed.png",'0px','0px']
         },
         {
            id:'scena8_1_ormar2_closed',
            type:'image',
            rect:['272px','266px','196px','324px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"scena8_1_ormar2_closed.png",'0px','0px']
         },
         {
            id:'scena8_1_ormar3_closed',
            type:'image',
            rect:['460px','266px','196px','324px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"scena8_1_ormar3_closed.png",'0px','0px']
         },
         {
            id:'scena8_1_pecnica_closed',
            type:'image',
            rect:['647px','266px','247px','324px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"scena8_1_pecnica_closed.png",'0px','0px']
         },
         {
            id:'scena8_1_ormar4_closed',
            type:'image',
            rect:['883px','266px','196px','324px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"scena8_1_ormar4_closed.png",'0px','0px']
         },
         {
            id:'scena8_1_ormar5',
            type:'rect',
            rect:['1070','-53','auto','auto','auto','auto']
         },
         {
            id:'scena8_1_prozor1',
            type:'rect',
            rect:['370','-36','auto','auto','auto','auto']
         },
         {
            id:'scena8_1_prozor2',
            type:'rect',
            rect:['745','-36','auto','auto','auto','auto']
         },
         {
            id:'scena8_1_stol_1',
            type:'image',
            rect:['214px','369px','740px','296px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"scena8_1_stol_1.png",'0px','0px']
         },
         {
            id:'scena8_1_kolacivino',
            type:'image',
            rect:['378px','226px','165px','178px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"scena8_1_kolacivino.png",'0px','0px']
         },
         {
            id:'scena8_1_lovac',
            type:'rect',
            rect:['-79','-25','auto','auto','auto','auto'],
            clip:['rect(0px 3500pxpx 660pxpx 0px)']
         },
         {
            id:'scena8_1_crvenkapica',
            type:'rect',
            rect:['543','226','auto','auto','auto','auto'],
            clip:['rect(0px 1800pxpx 473pxpx 0px)']
         },
         {
            id:'scena8_1_baka',
            type:'rect',
            rect:['843','194','auto','auto','auto','auto'],
            clip:['rect(0px 2160pxpx 522pxpx 0px)']
         },
         {
            id:'scena8_all',
            type:'rect',
            rect:['-249','-429','auto','auto','auto','auto']
         },
         {
            id:'text_slide2',
            type:'rect',
         ...
         {
            id:'scena8_1_ormar5',
            symbolName:'scena8_1_ormar5'
         },
         {
            id:'scena8_1_lovac',
            symbolName:'scena8_1_lovac'
         },
         {
            id:'scena8_1_baka',
            symbolName:'scena8_1_baka'
         },
         {
            id:'button_stop_',
         ...
         {
            id:'scena8_1_crvenkapica',
            symbolName:'scena8_1_crvenkapica'
         },
         {
            id:'scena8_1_prozor2',
            symbolName:'scena8_1_prozor2'
         }
         ]
      },
   states: {
      "Base State": {
         ...
         "${_scena8_1_baka}": [
            ["style", "clip", [0,270,522,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
         ],
         "${_scena8_all}": [
            ["style", "left", '-249px']
         ],
         "${_scena8_1_crvenkapica}": [
            ["style", "clip", [0,300,473,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
         ],
         "${_button_back}": [
            ["style", "height", '75px'],
            ["style", "top", '670px'],
         ...
         "${_scena8_1_ormar3_closed}": [
            ["style", "left", '460px'],
            ["style", "top", '266px']
         ],
         "${_scena8_1_ormari_back}": [
            ["style", "top", '-55px'],
            ["style", "left", '80px']
         ],
         "${_button_play_}": [
         ...
         "${_scena8_1_lovac}": [
            ["style", "clip", [0,500,660,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
         ],
         "${_button_next}": [
            ["style", "height", '75px'],
            ["style", "top", '669px'],
         ...
         "${_scena8_1_pecnica_closed}": [
            ["style", "left", '647px'],
            ["style", "top", '266px']
         ],
         "${_scena8_1_ormar1_closed}": [
            ["style", "left", '85px'],
            ["style", "top", '-51px']
         ],
         "${_scena8_1_ormar4_closed}": [
            ["style", "left", '883px'],
            ["style", "top", '266px']
         ],
         "${_scena8_1_kolacivino}": [
            ["style", "left", '378px'],
            ["style", "top", '226px']
         ],
         "${_button_meni}": [
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid861", tween: [ "style", "${_scena8_1_crvenkapica}", "clip", [0,300,473,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,300,473,0]}], position: 5750, duration: 0 },
            { id: "eid860", tween: [ "style", "${_scena8_1_lovac}", "clip", [0,500,660,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,500,660,0]}], position: 5750, duration: 0 },
            { id: "eid862", tween: [ "style", "${_scena8_1_baka}", "clip", [0,270,522,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,270,522,0]}], position: 5750, duration: 0 },
            { id: "eid556", tween: [ "style", "${_Stage}", "height", '755px', { fromValue: '755px'}], position: 0, duration: 0 },
            { id: "eid776", tween: [ "style", "${_scena8_all}", "left", '-249px', { fromValue: '-249px'}], position: 0, duration: 0 },
            { id: "eid874", tween: [ "style", "${_scena8_all}", "left", '-249px', { fromValue: '-249px'}], position: 4500, duration: 0 },
            { id: "eid777", tween: [ "style", "${_scena8_all}", "left", '-7460px', { fromValue: '-249px'}], position: 4750, duration: 0 }         ]
      }
   }
},
"ormar1": {
...
"meni": {
   ...
   },
   {
      id: 'str7',
      type: 'image',
      rect: ['755px','37px','195px','130px','auto','auto'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid875", tween: [ "style", "${_str7}", "top", '-151px', { fromValue: '37px'}], position: 0, duration: 1000 },
            { id: "eid876", tween: [ "style", "${_str7}", "top", '37px', { fromValue: '-151px'}], position: 1000, duration: 1000 },
...
"text_slide": {
   ...
   },
   {
      ...
      id: 'Text2',
      text: 'Kada se vuk naspavao, digne se iz kreveta i osjeti strašnu žeđ pa odvuče svoj teški trbuh do bunara da se napije. Ali kad se nagnuo iznad njega, kamenje u trbuhu ga povuče preko ruba i on se utopi u bunaru.<br><br>A baka, Crvenkapica i lovac proslaviše uz kolač i vino. A Crvenkapica obeća sama sebi: \"Od sada ću uvijek raditi onako kako mi kaže majka, i nikada neću skretati s puta.\"<br>',
      align: 'left',
...
"scena7_button_all": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid725", tween: [ "style", "${_scena7_bunarCopy}", "display", 'none', { fromValue: 'block'}], position: 8000, duration: 0 },
            { id: "eid722", tween: [ "style", "${_scena7_lovac_vrataCopy}", "display", 'none', { fromValue: 'block'}], position: 8000, duration: 0 },
            { id: "eid720", tween: [ "style", "${_scena7_trava_backCopy}", "display", 'none', { fromValue: 'block'}], position: 8000, duration: 0 },
            { id: "eid719", tween: [ "style", "${_scena7_travaCopy}", "display", 'none', { fromValue: 'block'}], position: 8000, duration: 0 },
            { id: "eid728", tween: [ "style", "${_scena7_neboCopy}", "display", 'none', { fromValue: 'block'}], position: 8000, duration: 0 },
            { id: "eid723", tween: [ "style", "${_scena7_kuca_leftCopy}", "display", 'none', { fromValue: 'block'}], position: 8000, duration: 0 },
            { id: "eid721", tween: [ "style", "${_scena7_kuca_rightCopy}", "display", 'none', { fromValue: 'block'}], position: 8000, duration: 0 },
            { id: "eid726", tween: [ "style", "${_scena7_drvo1Copy}", "display", 'none', { fromValue: 'block'}], position: 8000, duration: 0 },
            { id: "eid724", tween: [ "style", "${_scena7_kuca_backCopy}", "display", 'none', { fromValue: 'block'}], position: 8000, duration: 0 },
            { id: "eid727", tween: [ "style", "${_scena7_drvo2Copy}", "display", 'none', { fromValue: 'block'}], position: 8000, duration: 0 }         ]
      }
   }
},
"scena7_all1": {
...
"scena8_vuk_vrata": {
   ...
   dom: [
   {
      rect: ['258px','24px','4160px','458px','auto','auto'],
      id: 'scena8_vuk_sprite',
      type: 'image',
      clip: ['rect(0px 520px 458px 0px)'],
      fill: ['rgba(0,0,0,0)','images/scena8_vuk_sprite.png','0px','0px']
   },
   {
      id: 'scena8_kuca_vrata',
      type: 'image',
      rect: ['0px','0px','225px','495px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_kuca_vrata.png','0px','0px']
   }],
   symbolInstances: [
   ]
   },
   states: {
      "Base State": {
         ...
         "${_scena8_vuk_sprite}": [
            ["style", "top", '19px'],
            ["style", "display", 'block'],
            ["style", "clip", [0,520,458,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
            ["transform", "rotateZ", '0deg'],
            ["style", "height", '458px'],
            ["style", "left", '258px'],
            ["style", "background-position", [0,0], {valueTemplate:'@@0@@px @@1@@px'} ],
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid775", tween: [ "style", "${_scena8_vuk_sprite}", "top", '-264px', { fromValue: '19px'}], position: 2250, duration: 250 },
            { id: "eid755", tween: [ "style", "${_scena8_vuk_sprite}", "top", '-762px', { fromValue: '-264px'}], position: 2500, duration: 250 },
            { id: "eid758", tween: [ "style", "${_scena8_vuk_sprite}", "top", '-1396px', { fromValue: '-762px'}], position: 2750, duration: 250 },
            { id: "eid762", tween: [ "style", "${_scena8_vuk_sprite}", "top", '-2050px', { fromValue: '-1396px'}], position: 3000, duration: 250 },
            { id: "eid765", tween: [ "style", "${_scena8_vuk_sprite}", "top", '-1591px', { fromValue: '-2050px'}], position: 3250, duration: 250 },
            { id: "eid768", tween: [ "style", "${_scena8_vuk_sprite}", "top", '-186px', { fromValue: '-1591px'}], position: 3500, duration: 250 },
            { id: "eid769", tween: [ "style", "${_scena8_vuk_sprite}", "top", '-62px', { fromValue: '-186px'}], position: 3750, duration: 250 },
            { id: "eid744", tween: [ "style", "${_scena8_kuca_vrata}", "display", 'none', { fromValue: 'block'}], position: 500, duration: 0 },
            { id: "eid772", tween: [ "style", "${_scena8_vuk_sprite}", "display", 'none', { fromValue: 'block'}], position: 4250, duration: 0 },
            { id: "eid773", tween: [ "transform", "${_scena8_vuk_sprite}", "rotateZ", '-7deg', { fromValue: '0deg'}], position: 2250, duration: 250 },
            { id: "eid754", tween: [ "transform", "${_scena8_vuk_sprite}", "rotateZ", '-21deg', { fromValue: '-7deg'}], position: 2500, duration: 250 },
            { id: "eid757", tween: [ "transform", "${_scena8_vuk_sprite}", "rotateZ", '-43deg', { fromValue: '-21deg'}], position: 2750, duration: 250 },
            { id: "eid760", tween: [ "transform", "${_scena8_vuk_sprite}", "rotateZ", '-89deg', { fromValue: '-43deg'}], position: 3000, duration: 250 },
            { id: "eid763", tween: [ "transform", "${_scena8_vuk_sprite}", "rotateZ", '-136deg', { fromValue: '-89deg'}], position: 3250, duration: 250 },
            { id: "eid766", tween: [ "transform", "${_scena8_vuk_sprite}", "rotateZ", '-180deg', { fromValue: '-136deg'}], position: 3500, duration: 250 },
            { id: "eid747", tween: [ "style", "${_scena8_vuk_sprite}", "left", '-684px', { fromValue: '258px'}], position: 500, duration: 1750 },
            { id: "eid748", tween: [ "style", "${_scena8_vuk_sprite}", "left", '-704px', { fromValue: '-684px'}], position: 2250, duration: 250 },
            { id: "eid756", tween: [ "style", "${_scena8_vuk_sprite}", "left", '-862px', { fromValue: '-704px'}], position: 2500, duration: 250 },
            { id: "eid759", tween: [ "style", "${_scena8_vuk_sprite}", "left", '-1266px', { fromValue: '-862px'}], position: 2750, duration: 250 },
            { id: "eid761", tween: [ "style", "${_scena8_vuk_sprite}", "left", '-2652px', { fromValue: '-1266px'}], position: 3000, duration: 250 },
            { id: "eid764", tween: [ "style", "${_scena8_vuk_sprite}", "left", '-4048px', { fromValue: '-2652px'}], position: 3250, duration: 250 },
            { id: "eid767", tween: [ "style", "${_scena8_vuk_sprite}", "left", '-4658px', { fromValue: '-4048px'}], position: 3500, duration: 250 },
            { id: "eid770", tween: [ "style", "${_scena8_vuk_sprite}", "left", '-4654px', { fromValue: '-4658px'}], position: 3750, duration: 250 },
            { id: "eid736", tween: [ "style", "${_scena8_vuk_sprite}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 500, duration: 0 },
            { id: "eid737", tween: [ "style", "${_scena8_vuk_sprite}", "background-position", [-520,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 750, duration: 0 },
            { id: "eid738", tween: [ "style", "${_scena8_vuk_sprite}", "background-position", [-1040,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-520,0]}], position: 1000, duration: 0 },
            { id: "eid739", tween: [ "style", "${_scena8_vuk_sprite}", "background-position", [-1560,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1040,0]}], position: 1250, duration: 0 },
            { id: "eid740", tween: [ "style", "${_scena8_vuk_sprite}", "background-position", [-2080,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1560,0]}], position: 1500, duration: 0 },
            { id: "eid741", tween: [ "style", "${_scena8_vuk_sprite}", "background-position", [-2600,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-2080,0]}], position: 1750, duration: 0 },
            { id: "eid742", tween: [ "style", "${_scena8_vuk_sprite}", "background-position", [-3120,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-2600,0]}], position: 2000, duration: 0 },
            { id: "eid743", tween: [ "style", "${_scena8_vuk_sprite}", "background-position", [-3640,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-3120,0]}], position: 2250, duration: 0 }         ]
      }
   }
},
"scena8_all": {
   ...
   dom: [
   {
      id: 'scena8_nebo',
      type: 'image',
      rect: ['249px','380px','1280px','853px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_nebo.png','0px','0px']
   },
   {
      type: 'image',
      id: 'scena8_drvo2',
      rect: ['527px','0px','1490px','1184px','auto','auto'],
      clip: ['rect(424px 1002px 1185px 0px)'],
      fill: ['rgba(0,0,0,0)','images/scena8_drvo2.png','0px','0px']
   },
   {
      id: 'scena8_drvo1',
      type: 'image',
      rect: ['0px','89px','883px','1112px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_drvo1.png','0px','0px']
   },
   {
      id: 'scena8_bunar2',
      type: 'image',
      rect: ['195px','389px','457px','739px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_bunar2.png','0px','0px']
   },
   {
      id: 'scena8_kuca_back',
      type: 'image',
      rect: ['1191px','663px','328px','473px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_kuca_back.png','0px','0px']
   },
   {
      id: 'scena8_kuca_left2',
      type: 'image',
      rect: ['979px','429px','395px','799px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_kuca_left.png','0px','0px']
   },
   {
      id: 'scena8_vuk_vrata',
      type: 'rect',
      rect: ['1211px','663px','auto','auto','auto','auto']
   },
   {
      id: 'scena8_kuca_right2',
      type: 'image',
      rect: ['1342px','429px','187px','749px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_kuca_right.png','0px','0px']
   },
   {
      id: 'scena8_bunar1',
      type: 'image',
      rect: ['195px','389px','457px','739px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_bunar1.png','0px','0px']
   },
   {
      id: 'scena8_trava_back',
      type: 'image',
      rect: ['249px','1116px','1280px','102px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_trava_back.png','0px','0px']
   },
   {
      id: 'scena8_trava',
      type: 'image',
      rect: ['249px','1038px','1280px','90px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_trava.png','0px','0px']
   }],
   symbolInstances: [
   {
      id: 'scena8_vuk_vrata',
      symbolName: 'scena8_vuk_vrata'
   }   ]
   },
   states: {
      "Base State": {
...
"scena8_1_lovac": {
   ...
   dom: [
   {
      rect: ['0px','0px','3500px','660px','auto','auto'],
      id: 'scena8_1_lovac_sprite',
      type: 'image',
      clip: ['rect(0px 500px 660px 0px)'],
      fill: ['rgba(0,0,0,0)','images/scena8_1_lovac_sprite.png','0px','0px']
   }],
   symbolInstances: [
   ]
   },
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid790", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 0, duration: 0 },
            { id: "eid791", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 250, duration: 0 },
            { id: "eid792", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-1000,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-500,0]}], position: 500, duration: 0 },
            { id: "eid793", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-1500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1000,0]}], position: 750, duration: 0 },
            { id: "eid794", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-2000,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1500,0]}], position: 1000, duration: 0 },
            { id: "eid795", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-2500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-2000,0]}], position: 1250, duration: 0 },
            { id: "eid796", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-3000,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-2500,0]}], position: 1500, duration: 0 },
            { id: "eid797", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-3000,0]}], position: 1750, duration: 0 },
            { id: "eid798", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 2000, duration: 0 },
            { id: "eid799", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-1000,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-500,0]}], position: 2250, duration: 0 },
            { id: "eid800", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-1500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1000,0]}], position: 2500, duration: 0 },
            { id: "eid801", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-2000,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1500,0]}], position: 2750, duration: 0 },
            { id: "eid802", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-2500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-2000,0]}], position: 3000, duration: 0 },
            { id: "eid803", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-3000,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-2500,0]}], position: 3250, duration: 0 },
            { id: "eid804", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-3000,0]}], position: 3500, duration: 0 },
            { id: "eid805", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 3750, duration: 0 },
            { id: "eid806", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-1000,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-500,0]}], position: 4000, duration: 0 },
            { id: "eid807", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-1500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1000,0]}], position: 4250, duration: 0 },
            { id: "eid808", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-2000,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1500,0]}], position: 4500, duration: 0 },
            { id: "eid809", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-2500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-2000,0]}], position: 4750, duration: 0 },
            { id: "eid810", tween: [ "style", "${_scena8_1_lovac_sprite}", "background-position", [-3000,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-2500,0]}], position: 5000, duration: 0 }         ]
      }
   }
},
"scena8_1_crvenkapica": {
   version: "2.0.0",
   minimumCompatibleVersion: "2.0.0",
   build: "2.0.0.250",
   baseState: "Base State",
   ...
   dom: [
   {
      rect: ['-125px','0px','1800px','473px','auto','auto'],
      id: 'scena8_1_crvenkapica_sprite',
      type: 'image',
      clip: ['rect(0px 300px 473px 0px)'],
      fill: ['rgba(0,0,0,0)','images/scena8_1_crvenkapica_sprite.png','0px','0px']
   }],
   symbolInstances: [
   ]
   },
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid811", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 0, duration: 0 },
            { id: "eid812", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-300,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 250, duration: 0 },
            { id: "eid813", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-600,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-300,0]}], position: 500, duration: 0 },
            { id: "eid814", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-900,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-600,0]}], position: 750, duration: 0 },
            { id: "eid815", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-1200,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-900,0]}], position: 1000, duration: 0 },
            { id: "eid816", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-1500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1200,0]}], position: 1250, duration: 0 },
            { id: "eid817", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1500,0]}], position: 1500, duration: 0 },
            { id: "eid818", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-300,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 1750, duration: 0 },
            { id: "eid819", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-600,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-300,0]}], position: 2000, duration: 0 },
            { id: "eid820", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-900,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-600,0]}], position: 2250, duration: 0 },
            { id: "eid821", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-1200,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-900,0]}], position: 2500, duration: 0 },
            { id: "eid822", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-1500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1200,0]}], position: 2750, duration: 0 },
            { id: "eid823", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1500,0]}], position: 3000, duration: 0 },
            { id: "eid824", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-300,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 3250, duration: 0 },
            { id: "eid825", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-600,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-300,0]}], position: 3500, duration: 0 },
            { id: "eid826", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-900,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-600,0]}], position: 3750, duration: 0 },
            { id: "eid827", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-1200,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-900,0]}], position: 4000, duration: 0 },
            { id: "eid828", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-1500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1200,0]}], position: 4250, duration: 0 },
            { id: "eid854", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1500,0]}], position: 4500, duration: 0 },
            { id: "eid855", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-300,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 4750, duration: 0 },
            { id: "eid856", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-600,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-300,0]}], position: 5000, duration: 0 },
            { id: "eid857", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-900,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-600,0]}], position: 5250, duration: 0 },
            { id: "eid858", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-1200,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-900,0]}], position: 5500, duration: 0 },
            { id: "eid859", tween: [ "style", "${_scena8_1_crvenkapica_sprite}", "background-position", [-1500,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1200,0]}], position: 5750, duration: 0 }         ]
      }
   }
},
"scena8_1_baka": {
   ...
   dom: [
   {
      rect: ['0px','0px','2160px','522px','auto','auto'],
      id: 'scena8_1_baka_sprite',
      type: 'image',
      clip: ['rect(0px 270px 522px 0px)'],
      fill: ['rgba(0,0,0,0)','images/scena8_1_baka_sprite.png','0px','0px']
   }],
   symbolInstances: [
   ]
   },
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid830", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 0, duration: 0 },
            { id: "eid831", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-270,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 250, duration: 0 },
            { id: "eid832", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-540,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-270,0]}], position: 500, duration: 0 },
            { id: "eid833", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-810,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-540,0]}], position: 750, duration: 0 },
            { id: "eid834", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1080,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-810,0]}], position: 1000, duration: 0 },
            { id: "eid835", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1350,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1080,0]}], position: 1250, duration: 0 },
            { id: "eid836", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1620,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1350,0]}], position: 1500, duration: 0 },
            { id: "eid837", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1890,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1620,0]}], position: 1750, duration: 0 },
            { id: "eid838", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1890,0]}], position: 2000, duration: 0 },
            { id: "eid839", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-270,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 2250, duration: 0 },
            { id: "eid840", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-540,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-270,0]}], position: 2500, duration: 0 },
            { id: "eid841", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-810,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-540,0]}], position: 2750, duration: 0 },
            { id: "eid842", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1080,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-810,0]}], position: 3000, duration: 0 },
            { id: "eid843", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1350,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1080,0]}], position: 3250, duration: 0 },
            { id: "eid844", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1620,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1350,0]}], position: 3500, duration: 0 },
            { id: "eid845", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1890,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1620,0]}], position: 3750, duration: 0 },
            { id: "eid846", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1890,0]}], position: 4000, duration: 0 },
            { id: "eid847", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-270,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 4250, duration: 0 },
            { id: "eid848", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-540,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-270,0]}], position: 4500, duration: 0 },
            { id: "eid849", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-810,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-540,0]}], position: 4750, duration: 0 },
            { id: "eid850", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1080,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-810,0]}], position: 5000, duration: 0 },
            { id: "eid851", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1350,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1080,0]}], position: 5250, duration: 0 },
            { id: "eid852", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1620,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1350,0]}], position: 5500, duration: 0 },
            { id: "eid853", tween: [ "style", "${_scena8_1_baka_sprite}", "background-position", [-1890,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [-1620,0]}], position: 5750, duration: 0 }         ]
      }
   }
},
"scena8_1_ormar5": {
   ...
   dom: [
   {
      id: 'scena8_1_ormar5_closed',
      type: 'image',
      rect: ['0px','0px','205px','643px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_1_ormar5_closed.png','0px','0px']
   },
   {
      rect: ['0px','0px','205px','643px','auto','auto'],
      id: 'scena8_1_ormar5_open',
      type: 'image',
      display: 'none',
      fill: ['rgba(0,0,0,0)','images/scena8_1_ormar5_open.png','0px','0px']
   }],
   symbolInstances: [
   ]
   },
   states: {
      "Base State": {
         "${_scena8_1_ormar5_closed}": [
            ["style", "top", '0px'],
            ["style", "left", '0px'],
            ["style", "display", 'block']
         ],
         "${_scena8_1_ormar5_open}": [
            ["style", "top", '0px'],
            ["style", "left", '0px'],
            ["style", "display", 'none']
         ],
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid866", tween: [ "style", "${_scena8_1_ormar5_open}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0 },
            { id: "eid864", tween: [ "style", "${_scena8_1_ormar5_closed}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid865", tween: [ "style", "${_scena8_1_ormar5_closed}", "display", 'none', { fromValue: 'block'}], position: 500, duration: 0 },
            { id: "eid863", tween: [ "style", "${_scena8_1_ormar5_closed}", "display", 'block', { fromValue: 'none'}], position: 5750, duration: 0 }         ]
      }
   }
},
"scena8_1_prozor1": {
   ...
   dom: [
   {
      id: 'scena8_1_prozor1_closed',
      type: 'image',
      rect: ['0px','0px','196px','243px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_1_prozor1_closed.png','0px','0px']
   },
   {
      rect: ['0px','0px','196px','243px','auto','auto'],
      id: 'scena8_1_prozor1_open',
      type: 'image',
      display: 'none',
      fill: ['rgba(0,0,0,0)','images/scena8_1_prozor1_open.png','0px','0px']
   }],
   symbolInstances: [
   ]
   },
   states: {
      "Base State": {
         "${_scena8_1_prozor1_closed}": [
            ["style", "top", '0px'],
            ["style", "left", '0px'],
            ["style", "display", 'block']
         ],
         "${_scena8_1_prozor1_open}": [
            ["style", "top", '0px'],
            ["style", "left", '0px'],
            ["style", "display", 'none']
         ],
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid868", tween: [ "style", "${_scena8_1_prozor1_closed}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid869", tween: [ "style", "${_scena8_1_prozor1_closed}", "display", 'none', { fromValue: 'block'}], position: 500, duration: 0 },
            { id: "eid867", tween: [ "style", "${_scena8_1_prozor1_closed}", "display", 'block', { fromValue: 'none'}], position: 5750, duration: 0 },
            { id: "eid870", tween: [ "style", "${_scena8_1_prozor1_open}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0 }         ]
      }
   }
},
"scena8_1_prozor2": {
   ...
   dom: [
   {
      id: 'scena8_1_prozor2_closed',
      type: 'image',
      rect: ['0px','0px','196px','243px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/scena8_1_prozor2_closed.png','0px','0px']
   },
   {
      rect: ['0px','0px','196px','243px','auto','auto'],
      id: 'scena8_1_prozor2_open',
      type: 'image',
      display: 'none',
      fill: ['rgba(0,0,0,0)','images/scena8_1_prozor2_open.png','0px','0px']
   }],
   symbolInstances: [
   ]
   },
   states: {
      "Base State": {
         "${_scena8_1_prozor2_closed}": [
            ["style", "top", '0px'],
            ["style", "left", '0px'],
            ["style", "display", 'block']
         ],
         "${_scena8_1_prozor2_open}": [
            ["style", "top", '0px'],
            ["style", "left", '0px'],
            ["style", "display", 'none']
         ],
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid871", tween: [ "style", "${_scena8_1_prozor2_closed}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid872", tween: [ "style", "${_scena8_1_prozor2_closed}", "display", 'none', { fromValue: 'block'}], position: 500, duration: 0 },
            { id: "eid873", tween: [ "style", "${_scena8_1_prozor2_open}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0 }         ]
      }
   }
},
"button_mute_": {
