...
"stage": {
   ...
   content: {
         dom: [
         {
            ...
            fill:["rgba(0,0,0,0)",im+"scena5_soba.png",'0px','0px']
         },
         {
            id:'scena6_nocni_ormaric',
            type:'rect',
            rect:['960','-26','auto','auto','auto','auto']
         },
         {
            id:'scena6_prozor1',
            type:'rect',
            rect:['259','10','auto','auto','auto','auto']
         },
         {
            id:'scena6_prozor2',
            type:'rect',
            rect:['792','10','auto','auto','auto','auto']
         },
         {
            id:'scena6_crvenkapica',
            type:'rect',
            rect:['65','125','auto','auto','auto','auto'],
            clip:['rect(0px 2900pxpx 495pxpx 0px)']
         },
         {
            id:'scena6_misja_rupa_mis',
            type:'rect',
            rect:['-222','535','auto','auto','auto','auto']
         },
         {
            id:'scena6_vuk',
            type:'rect',
            rect:['222','100','auto','auto','auto','auto'],
            clip:['rect(0px 6480pxpx 698pxpx 0px)']
         },
         {
            id:'text_slide2',
            type:'rect',
         ...
         {
            id:'scena6_misja_rupa_mis',
            symbolName:'scena6_misja_rupa_mis'
         },
         {
            id:'scena6_nocni_ormaric',
            symbolName:'scena6_nocni_ormaric'
         },
         {
            id:'scena6_prozor1',
            symbolName:'scena6_prozor1'
         },
         {
            id:'scena6_crvenkapica',
            symbolName:'scena6_crvenkapica'
         },
         {
            id:'scena6_prozor2',
            symbolName:'scena6_prozor2'
         },
         {
            id:'meni2',
            symbolName:'meni'
...
"meni": {
   ...
   },
   {
      id: 'str8',
      type: 'image',
      rect: ['752px','37px','195px','130px','auto','auto'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid568", tween: [ "style", "${_str8}", "top", '-151px', { fromValue: '37px'}], position: 0, duration: 1000 },
            { id: "eid569", tween: [ "style", "${_str8}", "top", '37px', { fromValue: '-151px'}], position: 1000, duration: 1000 },
            ...
            { id: "eid566", tween: [ "style", "${_str7}", "top", '-151px', { fromValue: '37px'}], position: 0, duration: 1000 },
            { id: "eid567", tween: [ "style", "${_str7}", "top", '37px', { fromValue: '-151px'}], position: 1000, duration: 1000 },
...
"text_slide": {
   ...
   },
   {
      ...
      id: 'Text2',
      text: 'Bila je malo iznenađena kada je ulazna vrata našla otvorena, a kada je ušla u sobu, obuzme ju nekakva čudna nelagoda. Onda vikne još s vratiju: <br>\"Dobro jutro\", <br>ali ne dobije odgovor. Crvenkapica ode do prozora, razgrne zavjese i zatim ode do kreveta u kojem je ležala baka, kape navučene gotovo do nosa i malo čudnog izgleda.<br>\"Oh! Bako!\", reče, \"kako velike uši imaš!\"<br>\"Da te bolje čujem, dijete moje.\" dobije odgovor.<br>\"Ali bako, kako su ti velike oči!\", reče ona.<br>\"Da te bolje vidim, draga moja.\"<br>\"Ali bako, imaš tako velike ruke!\"<br>\"Da te mogu bolje zagrliti.\"<br>\"Ali, bako! Zašto imaš tako velika usta?\"<br>\"Da te bolje pojedem!\" <br>zaurla vuk, iskoči iz kreveta i proguta Crvenkapicu. Nakon toga vuk je napokon bio sit, pa legne u krevet, zaspi i u snu počne strašno hrkati. ',
      align: 'left',
...
"scena6_misja_rupa_mis": {
   ...
   dom: [
   {
      id: 'scena5_misjarupa',
      type: 'image',
      rect: ['227px','-5px','50px','139px','auto','auto'],
