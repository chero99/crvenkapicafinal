...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'scena4_nebo_oblaci',
            type:'rect',
            rect:['0','-54','auto','auto','auto','auto']
         },
         {
            id:'scena4_drvo1_ptica_crvena',
            type:'rect',
            rect:['32','-24','auto','auto','auto','auto']
         },
         {
            id:'scena4_drvo2_ptica_zuta',
            type:'rect',
            rect:['797','-80','auto','auto','auto','auto']
         },
         {
            id:'scena4_grm_plava_ptica',
            type:'rect',
            rect:['-372','417','auto','auto','auto','auto']
         },
         {
            id:'scena4_vuk',
            type:'rect',
            rect:['306','221','auto','auto','auto','auto'],
            clip:['rect(0px 3760pxpx 414pxpx 0px)']
         },
         {
            id:'scena4_crvenkapica',
            type:'rect',
            rect:['352','298','auto','auto','auto','auto']
         },
         {
            id:'scena4_trava_back_trava',
            type:'rect',
            rect:['0','524','auto','auto','auto','auto']
         },
         {
            id:'scena4_cvijece_1',
            type:'rect',
            rect:['0','621','auto','auto','auto','auto']
         },
         {
            id:'scena4_panj_jez',
            type:'rect',
            rect:['-239','495','auto','auto','auto','auto']
         },
         {
            id:'text_slide2',
            type:'rect',
         ...
         {
            id:'scena4_cvijece_1',
            symbolName:'scena4_cvijece_1'
         },
         {
            id:'scena4_crvenkapica',
            symbolName:'scena4_crvenkapica'
         },
         {
            id:'scena4_drvo1_ptica_crvena',
            symbolName:'scena4_drvo1_ptica_crvena'
         },
         {
            id:'button_stop_',
         ...
         {
            id:'scena4_nebo_oblaci',
            symbolName:'scena4_nebo_oblaci'
         },
         {
            id:'scena4_trava_back_trava',
            symbolName:'scena4_trava_back_tava'
         },
         {
            id:'scena4_vuk',
            symbolName:'scena4_vuk'
         },
         {
            id:'scena4_drvo2_ptica_zuta',
            symbolName:'scena4_drvo2_ptica_zuta'
         },
         {
            id:'scena4_grm_plava_ptica',
            symbolName:'scena4_grm_plava_ptica'
         },
         {
            id:'text_slide2',
   ...
   states: {
      "Base State": {
         ...
         "${_scena4_grm_plava_ptica}": [
            ["style", "left", '-374px'],
            ["style", "top", '419px']
         ],
         "${_scena4_drvo1_ptica_crvena}": [
            ["style", "clip", [0,1030,667,-58.49072265625], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
         ],
         "${_scena4_panj_jez}": [
            ["style", "top", '493px'],
            ["style", "clip", [35.41650390625,1558.25,188,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
         ],
         "${_button_back}": [
            ["style", "height", '75px'],
            ["style", "top", '670px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid461", tween: [ "style", "${_scena4_drvo1_ptica_crvena}", "clip", [0,1030,667,-58.49072265625], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,1030,667,-58.49072265625]}], position: 0, duration: 0 }         ]
      }
   }
},
"ormar1": {
...
"meni": {
   ...
   },
   {
      id: 'str6',
      type: 'image',
      rect: ['757px','37px','190px','127px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/6.png','0px','0px']
   },
   {
      id: 'str5',
      type: 'image',
      rect: ['521px','37px','190px','127px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/5.png','0px','0px']
   },
   {
      id: 'str3',
      type: 'image',
      rect: ['287px','37px','190px','127px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/3.png','0px','0px']
   },
   {
      id: 'str2',
      type: 'image',
      rect: ['53px','37px','190px','127px','auto','auto'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid453", tween: [ "style", "${_str3}", "top", '-151px', { fromValue: '37px'}], position: 0, duration: 1000 },
            { id: "eid454", tween: [ "style", "${_str3}", "top", '37px', { fromValue: '-151px'}], position: 1000, duration: 1000 },
            { id: "eid455", tween: [ "style", "${_str2}", "top", '-151px', { fromValue: '37px'}], position: 0, duration: 1000 },
            { id: "eid456", tween: [ "style", "${_str2}", "top", '37px', { fromValue: '-151px'}], position: 1000, duration: 1000 },
            ...
            { id: "eid451", tween: [ "style", "${_str5}", "top", '-151px', { fromValue: '37px'}], position: 0, duration: 1000 },
            { id: "eid452", tween: [ "style", "${_str5}", "top", '37px', { fromValue: '-151px'}], position: 1000, duration: 1000 },
            { id: "eid449", tween: [ "style", "${_str6}", "top", '-151px', { fromValue: '37px'}], position: 0, duration: 1000 },
            { id: "eid450", tween: [ "style", "${_str6}", "top", '37px', { fromValue: '-151px'}], position: 1000, duration: 1000 }         ]
      }
   }
},
"text_slide": {
   ...
   },
   {
      ...
      type: 'text',
      id: 'Text2',
      text: 'Vuk pomisli u sebi: \"Kako preslatka mala djevojčica, sigurno je izvrsnog okusa, boljeg nego njezina baka. Ali ako budem strpljiv, mogu pojesti obje.\" Zato je još neko vrijeme hodao pored Crvenkapice, a zatim reče: \"Vidi, Crvenkapice, kako je krasno cvijeće koje raste u šumi. Zamisli kako bi se baka radovala da joj ubereš koji stručak mirisnog šumskog cvijeća.\"<br>Crvenkapica zastane i zaista ugleda prekrasno cvijeće svih boja kako izviruje uz šumski put, između drveća i svugdje oko nje. \"Sigurna sam da će se baka veseliti. A kako je još rano, stignem ubrati malo cvijeća i stići na vrijeme do bake\" <br>reče Crvenkapica i skrene sa staze u šumu u potrazi za lijepim cvjetovima. Kad bi ubrala jedan, ugledala bi još jedan malo dalje i tako je, malo pomalo, ulazila sve dublje u šumu. ',
      align: 'left',
